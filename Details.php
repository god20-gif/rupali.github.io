...
<body>
  ...
  <table>
    ...
    $username = "root";
    $password = "";
    $conn = mysqli_connect($server, $username, $password, "rups");
    if (!$conn) {
    ...
    if (isset($_SESSION['user'])) {
      ...
      $sql = "SELECT * FROM rups WHERE name='$user'";
    ...
    <div class="card container">
      ...
      <form action="transfer.php" method="POST">
        ...
        <select name="reciever" id="dropdown" class="textbox" required>
          ...
          <?php
          $db = mysqli_connect("localhost", "root", "", "rups");
          $res = mysqli_query($db, "SELECT * FROM rups WHERE name!='$user'");
